...
class AuthController {
    ...
    public static function registro(Router $router) {
        ...
        $router->render('auth/registro', [
            'titulo' => 'Create your Account in DevWebCamp',
            'usuario' => $usuario, 
            'alertas' => $alertas
        ]);
    }
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if(empty($alertas)) {
                ...
                if($usuario && $usuario->confirmado) {
                    ...
                    $alertas['error'][] = 'The user does not exists or is not confirmed';
                }
            }
        }
    ...
    public static function confirmar(Router $router) {
        ...
        if(empty($usuario)) {
            ...
            Usuario::setAlerta('error', 'Invalid Token', 'The account is not verified');
        } else {
            // Confirmar la cuenta
        ...
        $router->render('auth/confirmar', [
            'titulo' => 'Confirm your account in DevWebcamp',
            'alertas' => Usuario::getAlertas()
        ]);
    }
}